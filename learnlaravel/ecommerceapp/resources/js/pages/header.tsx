export default function Header({homePageImg, homePageText, homePageBtnText}) {
    return (
        <div className="relative mt-15">
            ...
            <div className="absolute top-35 p-10">
                ...
                <a href="#" className="mt-5 rounded-md bg-gray-900 p-4 font-extrabold text-white hover:bg-gray-700">
                    Shop {homePageBtnText}!
                </a>
            </div>
        </div>
    );
